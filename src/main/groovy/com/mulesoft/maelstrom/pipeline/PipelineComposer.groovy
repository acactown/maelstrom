...
class PipelineComposer {
    ...
    PipelineComposer addPhase (Phase phase, ChainComposer.Position position, String relativeToName) {
    ...
    PipelineComposer addStage (Stage stage, ChainComposer.Position position, String relativeToName) {
